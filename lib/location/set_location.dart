import 'dart:async';
import 'dart:convert';
import 'package:farcon/location/animated_location_marker.dart';
import 'package:farcon/location/farmers_list_screen.dart';
...
Future<void> setCustomMarkerIcon() async {
  ...
  Future<String> getAddressFromLatLng(LatLng position) async {
    final url =
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=AIzaSyANbVqc6741dccjS8kJcmuIzTu-lx1J_9k';
            ...
            children: [
              ...
              Center(
                            child: Column(
                              ...
                              children: [
                                Transform.translate(
                                  offset: const Offset(0, -20), // Adjust this offset to center the marker
