...
import 'package:farcon/models/charges.dart';
...
class ShopDetailsProvider with ChangeNotifier {
  ...
  Future<void> initializeShopDetails(BuildContext context) async {
    print('🚀 ENTRY POINT: initializeShopDetails called');
    if (_shopDetails != null) {
      print('⏭️ Shop details already exist, skipping initialization');
      return;
    }
    ...
    try {
      print('📞 Creating HomeServices instance');
      final homeServices = HomeServices();
      
      print('🔥 About to call fetchShopDetails');
      await HomeServices.fetchShopDetailsByCode(context, "123456");
      print('✅ fetchShopDetails completed');
      
      _error = null;
    } catch (e) {
      print('💥 Error in initializeShopDetails: $e');
  ...
  /// New Method: Set List of Shop Details
  void setShopList(List<ShopDetails> shopList) {
    print('📝 Setting shop list with ${shopList.length} items');
    _shopList = shopList;
    notifyListeners();
    print('✅ Shop list updated successfully');
  }
