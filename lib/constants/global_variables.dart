...
String uri = 'http://192.168.2.160:4000';

class GlobalVariables {
  // Applied coupon
  static int? appliedCouponOffer;
  ...
  static const List<Map<String, dynamic>> groceryImages = [
    {
      ...
      'sub-title': ['Lehenga', 'cloths', 'dress','watch','shivprasad','Atta', 'Rice','Dal'],
    },
    {
...
static const List<Map<String, dynamic>> categoryImages = [
    ...
    static const List<Map<String, dynamic>> paymentImages = [
    {
